...
class ResponseGeneratorTaskComplete:
    def execute(self, state):
        ...
        speak_output = "<amazon:emotion name='excited' intensity='medium'> Task completed! </amazon:emotion> To exit Taskbot mode, just say stop. Or ask anything to start a new search."
